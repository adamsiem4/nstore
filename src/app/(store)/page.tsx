    ...
    <div className="flex flex-1 flex-col rounded-xl border bg-card p-5 sm:p-8 lg:p-10">
      ...
      <main id="content" tabIndex={-1} className="outline-none">
        <section
          ...
          className="relative isolate -mx-2 -mt-2 mb-10 flex min-h-[70svh] flex-col items-center justify-center overflow-hidden rounded-xl border px-6 py-16 text-center text-white sm:-mx-5 sm:-mt-5 sm:mb-12 sm:min-h-[78svh] sm:px-10 sm:py-24 lg:-mx-7 lg:-mt-7"
        >
          <Image
          ...
          />
          {/* ponytail: scrim, not decoration — the gradient's light teal end
              would drop white text under 4.5:1. */}
          <div aria-hidden="true" className="absolute inset-0 -z-10 bg-black/40" />
          <p className="inline-flex items-center gap-2 rounded-full border border-white/35 bg-white/10 px-3 py-2 text-xs font-medium tracking-wide">
          ...
          <p className="mt-6 max-w-md text-pretty text-base leading-7 text-white/85 sm:text-lg sm:leading-8">
          ...
          <div className="mt-8 flex w-full flex-wrap justify-center gap-3">
            <Link
              ...
              className={cn(
                buttonVariants(),
                "h-12 w-full gap-3 rounded-full bg-white px-6 text-sm text-neutral-900 hover:bg-white/90 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-transparent min-[420px]:w-auto",
              )}
            >
              Shop the essentials
            ...
            <a
              ...
              className={cn(
                ...
                "h-12 w-full gap-3 rounded-full border-white/45 bg-transparent px-6 text-sm text-white hover:bg-white/10 hover:text-white focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-transparent min-[420px]:w-auto",
              )}
            >
              Meet the favourites
